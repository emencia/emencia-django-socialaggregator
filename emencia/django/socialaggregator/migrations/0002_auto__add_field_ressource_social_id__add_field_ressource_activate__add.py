...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.social_id'
        db.add_column(u'socialaggregator_ressource', 'social_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)

        # Adding field 'Ressource.activate'
        db.add_column(u'socialaggregator_ressource', 'activate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Ressource.favorite'
        db.add_column(u'socialaggregator_ressource', 'favorite',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ressource.social_id'
        db.delete_column(u'socialaggregator_ressource', 'social_id')

        # Deleting field 'Ressource.activate'
        db.delete_column(u'socialaggregator_ressource', 'activate')

        # Deleting field 'Ressource.favorite'
        db.delete_column(u'socialaggregator_ressource', 'favorite')
