...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.text_display'
        db.add_column(u'socialaggregator_ressource', 'text_display',
                      self.gf('django.db.models.fields.CharField')(default='default', max_length=100),
                      keep_default=False)


        # Changing field 'Ressource.view_size'
        db.alter_column(u'socialaggregator_ressource', 'view_size', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'Ressource.text_display'
        db.delete_column(u'socialaggregator_ressource', 'text_display')


        # Changing field 'Ressource.view_size'
        db.alter_column(u'socialaggregator_ressource', 'view_size', self.gf('django.db.models.fields.IntegerField')())
