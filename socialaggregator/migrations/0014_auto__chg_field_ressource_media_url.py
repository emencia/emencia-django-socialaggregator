...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ressource.media_url'
        db.alter_column(u'socialaggregator_ressource', 'media_url', self.gf('django.db.models.fields.URLField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Ressource.media_url'
        db.alter_column(u'socialaggregator_ressource', 'media_url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        u'socialaggregator.ressource': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 1, 3, 0, 0)'}),
