...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.button_label'
        db.add_column(u'socialaggregator_ressource', 'button_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ressource.button_label'
        db.delete_column(u'socialaggregator_ressource', 'button_label')
