...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.has_external_url'
        db.add_column(u'socialaggregator_ressource', 'has_external_url',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Ressource.external_url'
        db.add_column(u'socialaggregator_ressource', 'external_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ressource.has_external_url'
        db.delete_column(u'socialaggregator_ressource', 'has_external_url')

        # Deleting field 'Ressource.external_url'
        db.delete_column(u'socialaggregator_ressource', 'external_url')
    ...
    models = {
        ...
        u'socialaggregator.ressource': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 7, 8, 0, 0)'}),
            ...
            'feeds': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['socialaggregator.Feed']", 'symmetrical': 'False'}),
            'has_external_url': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
