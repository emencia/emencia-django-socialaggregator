...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.view_size'
        db.add_column(u'socialaggregator_ressource', 'view_size',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ressource.view_size'
        db.delete_column(u'socialaggregator_ressource', 'view_size')
    ...
    models = {
        ...
        u'socialaggregator.ressource': {
            ...
            'view_size': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'taggit.tag': {
