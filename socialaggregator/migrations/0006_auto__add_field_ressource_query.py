...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.query'
        db.add_column(u'socialaggregator_ressource', 'query',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ressource.query'
        db.delete_column(u'socialaggregator_ressource', 'query')
