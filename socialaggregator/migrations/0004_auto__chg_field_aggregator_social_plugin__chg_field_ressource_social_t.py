...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Aggregator.social_plugin'
        db.alter_column(u'socialaggregator_aggregator', 'social_plugin', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Ressource.social_type'
        db.alter_column(u'socialaggregator_ressource', 'social_type', self.gf('django.db.models.fields.CharField')(max_length=250))

    def backwards(self, orm):

        # Changing field 'Aggregator.social_plugin'
        db.alter_column(u'socialaggregator_aggregator', 'social_plugin', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Ressource.social_type'
        db.alter_column(u'socialaggregator_ressource', 'social_type', self.gf('django.db.models.fields.IntegerField')())
