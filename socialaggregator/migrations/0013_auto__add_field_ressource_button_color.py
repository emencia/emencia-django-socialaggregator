...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.button_color'
        db.add_column(u'socialaggregator_ressource', 'button_color',
                      self.gf('django.db.models.fields.CharField')(default='black', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ressource.button_color'
        db.delete_column(u'socialaggregator_ressource', 'button_color')
