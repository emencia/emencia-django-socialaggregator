...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.media_url'
        db.add_column(u'socialaggregator_ressource', 'media_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Ressource.media_url_type'
        db.add_column(u'socialaggregator_ressource', 'media_url_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ressource.media_url'
        db.delete_column(u'socialaggregator_ressource', 'media_url')

        # Deleting field 'Ressource.media_url_type'
        db.delete_column(u'socialaggregator_ressource', 'media_url_type')
