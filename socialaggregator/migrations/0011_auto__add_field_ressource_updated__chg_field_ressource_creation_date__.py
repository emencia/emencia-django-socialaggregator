...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ressource.updated'
        db.add_column(u'socialaggregator_ressource', 'updated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Ressource.creation_date'
        db.alter_column(u'socialaggregator_ressource', 'creation_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Ressource.update_date'
        db.alter_column(u'socialaggregator_ressource', 'update_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Ressource.updated'
        db.delete_column(u'socialaggregator_ressource', 'updated')


        # Changing field 'Ressource.creation_date'
        db.alter_column(u'socialaggregator_ressource', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Ressource.update_date'
        db.alter_column(u'socialaggregator_ressource', 'update_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'socialaggregator.ressource': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 18, 0, 0)'}),
            ...
            'update_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'blank': 'True'}),
